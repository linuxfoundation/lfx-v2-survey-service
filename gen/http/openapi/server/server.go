...
import (
	...
	openapi "github.com/linuxfoundation/lfx-v2-survey-service/gen/openapi"
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"Serve gen/http/openapi.json", "GET", "/_survey/openapi.json"},
			{"Serve gen/http/openapi.yaml", "GET", "/_survey/openapi.yaml"},
			{"Serve gen/http/openapi3.json", "GET", "/_survey/openapi3.json"},
			{"Serve gen/http/openapi3.yaml", "GET", "/_survey/openapi3.yaml"},
		},
...
func Mount(mux goahttp.Muxer, h *Server) {
	MountGenHTTPOpenapiJSON(mux, http.StripPrefix("/_survey", h.GenHTTPOpenapiJSON))
	MountGenHTTPOpenapiYaml(mux, http.StripPrefix("/_survey", h.GenHTTPOpenapiYaml))
	MountGenHTTPOpenapi3JSON(mux, http.StripPrefix("/_survey", h.GenHTTPOpenapi3JSON))
	MountGenHTTPOpenapi3Yaml(mux, http.StripPrefix("/_survey", h.GenHTTPOpenapi3Yaml))
}
...
func MountGenHTTPOpenapi3Yaml(mux goahttp.Muxer, h http.Handler) {
	mux.Handle("GET", "/_survey/openapi3.yaml", h.ServeHTTP)
}
